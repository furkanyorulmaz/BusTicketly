...
if (isset($_POST['choose_seat_buy'])) {
    $number = $_POST['number'];
    ...
    <div class="container">
    <h1>Information For Buy Ticket</h1>
    <hr>
    <?php
    ...
    <div class="cancel_signup">
        ...
        <button type="submit" class="addjourneybtn" name="regUser">Next</button>
    </div>
    </div>
</form>
...
if (isset($_POST['regUser'])) {
    ...
    echo header("Location: ticketPaymentBuy_RU.php");
    exit();
}
?>