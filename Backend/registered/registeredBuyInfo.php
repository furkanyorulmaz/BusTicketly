    ...
    <form action="#" method="POST">
        <div class="container">
            ...
            <div class="cancel_signup">
                ...
                <button type="submit" class="addjourneybtn" name="registered_buy">Next</button>
            </div>
        </div>
    </form>
...
if (isset($_POST['registered_buy'])) {
    #post edilen değerler check edilmedi
    $name = $_POST['name'];
    ...
    if (!$insertTicketTable) {
        ...
        echo '<script> window.location.href = "chooseSeatNoBuy_RU.php"</script>';
        exit();
    }
}
