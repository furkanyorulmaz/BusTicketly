...
<<<<<<< HEAD
            ...
            <button type="submit" class="nextbtn" style="background-color: cornflowerblue" name="choose_seat_buy">Next
            </button>
...
/*if (isset($_POST['choose_seat'])) {
    ...
    $journeyId = $_SESSION['journeyId'];
    echo '<script> window.location.href = "registeredBuyInfo.php"</script>';
}*/
