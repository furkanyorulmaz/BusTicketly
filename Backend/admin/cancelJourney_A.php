...
if (isset($_POST['cancelJourney'])) {
    ...
    if (!$result) {
        ...
        while ($row = mysqli_fetch_assoc($findTicketCustomersConn)) {
            ...
            $cancelTicket = "UPDATE ticket SET isCancelled='1', ticketType='Cancelled' WHERE journeyId='$journeyId' AND PNR='$pnr'";
        ...
        while ($row2 = mysqli_fetch_assoc($findReserveCustomersConn)) {
            ...
            $cancelTicket = "UPDATE reservation SET isCancelled='1', ticketType='Cancelled' WHERE journeyId='$journeyId' AND reservationId='$pnr'";
            $cancelAll = mysqli_query($conn, $cancelTicket);
        }
